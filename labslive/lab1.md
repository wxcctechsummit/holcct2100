...
- [Part 1: Control Hub User Management Admin Task](#part-3-control-hub-user-management-admin-task)
  * [1. Add an agent user and configure the calling extension](#2-add-an-agent-user-and-configure-the-calling-extension)
  * [2. Add an admin user and configure the calling extension](#1-add-an-admin-user-and-configure-the-calling-extension)
  * [3. Add rest of the users](#4-add-rest-of-the-users)
...
### 1. Add an agent user and configure the calling extension
...
### 2. Optionally, add an admin user and configure the calling extension
...
- Click on **_Manually Add or Modify User_**
- Select **_Next_** in **_Manage Users_** pane.
- Input the **_EmailID_** of the new user and click **_Next_**
- Check **_Webex Teams_** , **_Webex Calling (Enterprise)_** & **_Contact Center_**
...
Now you are ready to start the Lab 2 "New Agent Desktop Experience"
...
| 1.1         | Minor Update   | Dmitry Bokatov (dbokatov) | 23 Feb 2021 |
