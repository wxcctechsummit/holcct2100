...
- Click `Add Group` in **Email Distribution** and select `Team1_wxcclab_<ID>` as created earlier.
...
- Click `Add Group` in **Chat Distribution** and select `Team1_wxcclab_<ID>` as created earlier
